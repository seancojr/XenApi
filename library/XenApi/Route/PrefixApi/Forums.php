...
class XenApi_Route_PrefixApi_Forums implements XenForo_Route_Interface
{
	/**
	...
	{
		$action = $router->resolveActionWithIntegerParam($routePath, $request, 'node_id', 'index');
		return $router->getRouteMatch('XenApi_ControllerApi_Forum', $action);
	}
}
